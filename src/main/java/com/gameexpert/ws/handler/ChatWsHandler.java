...
public class ChatWsHandler implements WsMessageHandler {
    ...
    private ChatResponse createResponse(WsMessageContext context, String content) {
        ...
        ChatMessageResponse chatMsgRes = chatService.saveMessage(context.worldId(), context.nickname(), content);
        ChatResponse res = new ChatResponse(chatMsgRes.getSender(), chatMsgRes.getContent(), chatMsgRes.getCreatedAt());
        return res;
    }
}
